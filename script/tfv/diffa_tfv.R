...
figDir <- here("deliv/figure/tfv/diffa")
if(!dir.exists(figDir)) dir.create(figDir)

theme_set(theme_bw())

options(mrg.script="diffa_tfv.R", mrggsave.dir=figDir)
...
ph.obj
head(sample_data(ph.obj)$tfv_t_exposures, 25)

# Convert a `phyloseq` object to a `deseq2` object ------------------------

deseq.obj <- phyloseq_to_deseq2(ph.obj, ~ tfv_t_exposures)
